...
export default function AdminUserEdit({ user, availableRoles }: UserEditProps) {
  ...
  const breadcrumbs = [
    ...
    { title: 'Edit', href: `/admin/users/${user.uuid}/edit` }
  ];
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    router.put(`/admin/users/${user.uuid}`, formData, {
      onSuccess: () => {
  ...
  const handleCancel = () => {
    router.get(`/admin/users/${user.uuid}`);
  };
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Update {user.name}'s profile and system information
                </p>
              </div>
            </div>
          </div>
                    ...
                    <AlertDescription>
                      ...
                      {selectedRole.permissions_count > 0 && (
                        <span className="text-muted-foreground ml-2">
                          ({selectedRole.permissions_count} permissions)
                        </span>
                      )}
                    </AlertDescription>
                  </Alert>
